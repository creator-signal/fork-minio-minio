...
// Creator Signal retains the last complete AGPL console locally because the
// archived upstream server now embeds a reduced object-browser-only console.
replace github.com/minio/console => ./creatorsignal/console

// Prometheus v0.311.3 requires this compatibility pin for the split
// go-openapi YAML assertion modules. Dependency-module replace directives are
// not inherited by the main module.
